...
if debug:
    ...
    iter_step = 10
    hyperopt_param = {}
    hyperopt_param["xgb_max_evals"] = 100
...
feat_name = "GBDT_pred_leaf_[Model@reg_xgb_tree]"
...
feat_folder = "./feat_folder"
feat_name = "[GBDT_pred_leaf_[Model@reg_xgb_linear]"
feat_folders.append( feat_folder )
feat_names.append( feat_name )
param_spaces[feat_name] = param_space_reg_xgb_linear
## softkappa with xgboost linear booster
feat_folder = "./feat_folder"
feat_name = "GBDT4LR_[Model@kappa_xgb_linear]"
feat_folders.append( feat_folder )
feat_names.append( feat_name )
...
###########################
feat_folder = "./feat_folder"
feat_name = "[GBDT4FFM_feats_[Model@reg_libffm]"
feat_folders.append( feat_folder )
feat_names.append( feat_name )
param_spaces[feat_name] = param_space_reg_libffm
